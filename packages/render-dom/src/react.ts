...
/**
 * Selects one backend for the lifetime of one authoritative surface. The
 * default remains compatibility until a caller's complete View subset has a
 * declared React lowering.
 */
