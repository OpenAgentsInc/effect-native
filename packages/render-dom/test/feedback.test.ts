    ...
    await Effect.runPromise(
      Effect.scoped(
        Effect.gen(function* () {
          ...
          ;(dangerCard?.querySelector('[data-en-role="dismiss"]') as HTMLElement | null)?.dispatchEvent(
          ...
          ;(banner?.querySelector('[data-en-role="retry"]') as HTMLElement | null)?.dispatchEvent(
            new window.MouseEvent("click", { bubbles: true }) as unknown as Event
          )
          yield* nextTask
          ...
          ;(recovery?.querySelector('[data-en-action="retry"]') as HTMLElement | null)?.dispatchEvent(
            new window.MouseEvent("click", { bubbles: true }) as unknown as Event
          )
          yield* nextTask
