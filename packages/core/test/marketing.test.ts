...
describe("marketing catalog v20 (#46–#51)", () => {
  test("constructs and round-trips the landing primitives", () => {
    const landing = Section({ key: "landing", width: "contained", paddingY: "6", background: "surface" }, [
      AnnouncementBadge({
        key: "announce",
        label: "Now open",
      ...
      Hero({
        ...
        media: MockupFrame({ key: "shot", variant: "browser", tilt: "left" }, [
          Glow({ key: "glow", intensity: "md" }, [Text({ key: "shot-label", content: "Product", variant: "body" })])
        ])
      }),
      LogoRow({
        key: "logos",
