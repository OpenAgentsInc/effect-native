...
const EmailSchema = Schema.String.check(Schema.isPattern(/^[^@\s]+@[^@\s]+\.[^@\s]+$/, { title: "Email" }))
const NameSchema = Schema.String.check(Schema.isPattern(/\S/, { title: "NonBlank" }))
