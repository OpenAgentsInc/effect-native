...
`effect-native/v26` is shipped (marketing landing, mobile Pager/pull-to-refresh/SwipeableListItem, the media-video live attach host); the chat vertical-slice proof is in
