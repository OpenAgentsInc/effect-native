...
| Full Khala Code Mobile app conversion | Every mobile screen authored once as typed EN data on iOS + Android; the owner-named cross-app Khala Sync messaging exit test (desktop EN chat ↔ mobile EN chat, live) | 2026-07-09 | partial -> #64 (UI proof + cross-renderer oracle shipped: onboarding/threads/chat; live Khala Sync desktop↔mobile messaging remains product/runtime outside this repo); [`docs/proof-mobile.md`](./docs/proof-mobile.md) |
